...
<link id="gf-JetBrains-Mono" href="https://fonts.googleapis.com/css2?family=JetBrains+Mono&display=swap" rel="stylesheet">
<style>
...
const ROWS=[{lb:"5H",pct:42,rs:"5:30p"},{lb:"1W",pct:63,rs:"Wed"},{lb:"OP",pct:55,rs:"Sep 20"}];

function defaults(){return {
  font:"JetBrains Mono", showSeconds:false,
  bg:"#000000", accent:"#D97757", val:"#FFFFFF", dim:"#AAAAAA", track:"#333333", cap:"#FF5F5F",
  el:{
    prompt:{name:"Prompt line", kind:"text", x:0.500, y:0.100, size:26, text:"claude ~ %"},
    time:  {name:"Time",        kind:"time", x:0.500, y:0.170, size:58},
    date:  {name:"Date",        kind:"date", x:0.500, y:0.400, size:26},
    rows:  {name:"Meter rows",  kind:"rows", y:0.540, gap:0.105, size:26,
            labelX:0.150, barX:0.320, barW:0.160, barH:0.035, pctX:0.650, resetX:0.860},
    cursor:{name:"Cursor",      kind:"cursor", x:0.500, y:0.870, w:0.030, h:0.028},
  }};}
