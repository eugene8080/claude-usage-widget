...
- **Every rolling window at a glance.** The 5-hour and 1-week usage percentages plus the separate 1-week Fable cap, each with a live countdown to its reset. The Fable row is hidden automatically on plans where the endpoint doesn't meter one.
