...
const SEC_IDX=21;
function defaults(){return {font:"Commit Mono",accent:"#ff531a",text1:"#ff9c75",text2:"#ffffff",text3:"#9a9a9a",hourCol:"#FFFFFF",grad1:"#B5502F",grad2:"#FFC08A",
