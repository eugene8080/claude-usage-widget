...
function defaults(){return {font:"Chivo Mono",accent:"#ff531a",text1:"#ff9c75",text2:"#ffffff",text3:"#9a9a9a",hourCol:"#FFFFFF",grad1:"#ff9255",grad2:"#ff3c3b",
  arc:{span:74,dashW:10,dashLen:15,frac:0.5,rad:228},
  el:{
  ...
  brand:{name:"Brand text",kind:"brand",x:0.500,y:0.169,num:31,text:"TACTIX"},
  ...
  date:{name:"Date",kind:"date",x:0.500,y:0.832,num:30,gap:81},
